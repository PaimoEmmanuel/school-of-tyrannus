      ...
      >
        ...
        <Box>
          ...
          <Grid templateColumns="repeat(2, minmax(0, 1fr))" mt="30px">
            <Box>
              <Text opacity="0.6" fontSize="14px" mb="26px">
                <a href="https://nlwc.church/contact/" target='_blank' rel="noreferrer">Contact</a>
              </Text>
              <Text opacity="0.6" fontSize="14px" mb="26px">
                <a href="https://www.instagram.com/accounts/login/?next=/nlwclife/" target='_blank' rel="noreferrer">Instagram</a>
              </Text>
            </Box>
            <Box>
              <Text opacity="0.6" fontSize="14px" mb="26px">
                <a href="https://twitter.com/nlwclife?lang=en" target='_blank' rel="noreferrer">Twitter </a>
              </Text>
              <Text opacity="0.6" fontSize="14px" mb="26px">
                <a href="https://www.youtube.com/nlwclife" target='_blank' rel="noreferrer">Youtube</a>
              </Text>
            </Box>
          </Grid>
        </Box>
